...
alter table public.release_item_artist
    add column ordinal integer,
    add constraint ck_release_item_artist_ordinal_non_negative
        check (ordinal is null or ordinal >= 0) not valid;

comment on column public.release_item_artist.ordinal is
